...
<!--          A motivated software developer with 5+ years of experience in building scalable web applications.
	  ...
	  -->
	  Skriv noe some passer om meg her.
	  Brødtekts...
        </p>
      </section>

      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>Erfaring</h2>
	!--
	...
	-->
        <div style={styles.job}>
          <h3 style={styles.jobTitle}>Job tittel</h3>
          <p style={styles.company}>Job sted | Jun 2017 - Dec 2019</p>
          <ul style={styles.list}>
            <li>Job beskrivelse kommer her.</li>
            <li>flere linjer med tekst.</li>
          </ul>
        </div>
      </section>

      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>Utdannning</h2>
        <p style={styles.text}>B.Sc. in Computer Science, University of Tech | Graduated: 2017</p>
      </section>

      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>Ferdigheter</h2>
        <ul style={styles.list}>
